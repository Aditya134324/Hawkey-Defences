    ...
    <div className="hero">
      <section className={styles.section}>
        ...
        <p className={styles.p1}>
          -------------------------------- <br />
          TRUSTED DEFENCE SOLUTIONS <br />
          --------------------------------
        </p>

        <pre className={styles.stripes}>
          /////////////////////////////////
        </pre>

        <div className={styles.line}>REVOLUTIONISING</div>

        <div className={styles.line}>
          THE DEFENCE
          <span className={styles.outline}> WITH MODERN</span>
        </div>

        <div className={`${styles.line} ${styles.outline}`}>
          TECHNOLOGY
        </div>
